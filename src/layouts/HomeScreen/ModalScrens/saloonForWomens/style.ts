...
const styles = StyleSheet.create({
    ...
    ratingText: {
      ...
      fontFamily: 'Roboto-Bold', // Changed font-family to bold
    ...
    price: {
      ...
      color: '#000', // Dark black color
      marginBottom: 5,
      borderBottomWidth: 2, // Border width for dashed line
      borderStyle: 'dashed',
      borderColor: 'lightgrey', // Light grey color for the dashed line
      paddingBottom: 2, // Gap between the price and the dashed line
      fontFamily: 'Roboto-Bold', // Changed font-family
      opacity: 0.8,
    },
    description: {
